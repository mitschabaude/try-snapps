...
let smallBits = smallFieldElt.toBits(32);
...
let msg0 = [0xba5eba11, 0x15, 0xbad].map((x) => new Field(x));
let msg1 = [0xfa1afe1, 0xc0ffee].map((x) => new Field(x));
